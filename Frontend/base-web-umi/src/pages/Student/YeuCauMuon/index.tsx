        ...
        <div style={{
            ...
            <div style={{ maxWidth: '560px', margin: '0 auto' }}>
                <div style={{ marginBottom: '24px', textAlign: 'left' }}>
                    <Title level={2} style={{ marginBottom: '4px' }}>Yêu cầu mượn thiết bị</Title>
                    <Paragraph type='secondary'>Điền thông tin để gửi yêu cầu mượn thiết bị nhanh chóng</Paragraph>
                </div>

                <Card style={{ borderRadius: '16px', boxShadow: '0 10px 25px -5px rgba(0, 0, 0, 0.05)', border: 'none' }} bodyStyle={{ padding: '32px' }}>
                    {/* BẮT BUỘC: initialValues={{ quantity: 1 }} để Input hiển thị số 1 ngay khi load trang */}
                    <Form form={form} layout='vertical' onFinish={handleSubmit} initialValues={{ quantity: 1 }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            ...
                            >
                                <DatePicker style={{ width: '100%' }} size='large' format='MM/DD/YYYY' disabledDate={(current) => current && current < moment().startOf('day')} />
                            </Form.Item>
                        </div>

                        {/* Phải bọc Input số lượng trong Form.Item name='quantity' để Form quản lý giá trị */}
                        <Form.Item label={<span style={{ fontWeight: 600 }}>Số lượng</span>} name='quantity' rules={[{ required: true }]}>
                            <Space>
                        ...
                        <Form.Item style={{ marginBottom: 0 }}>
                            <Space size='middle'>
                                <Button type='primary' htmlType='submit' loading={submitting} icon={<SendOutlined />}>Gửi yêu cầu</Button>
